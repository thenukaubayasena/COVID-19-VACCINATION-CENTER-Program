...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        WaitingList astraZenecaWaitingList = new WaitingList();
        WaitingList synopharmWaitingList = new WaitingList();
        WaitingList pfizerWaitingList = new WaitingList();
        ...
        while(repeat) {
            ...
            if(menuChoice.equals("999") || menuChoice.equalsIgnoreCase("EXT")) {
                ...
                vaccinationCenterClass.addPatientToBooth(patient,astraZenecaWaitingList,synopharmWaitingList,pfizerWaitingList);
                ...
                vaccinationCenterClass.deletePatient(boothNum,patient,astraZenecaWaitingList,synopharmWaitingList,pfizerWaitingList);
