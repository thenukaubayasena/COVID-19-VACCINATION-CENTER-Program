    ...
    public static void main(String[] args) throws IOException{
        ...
        while(repeat) {
            ...
            if(menuChoice.equals("999") || menuChoice.equalsIgnoreCase("EXT")) {
                ...
                vaccinationCenterClass.viewAllBooths();
                ...
                vaccinationCenterClass.addPatientToBooth();
                ...
                vaccinationCenterClass.deletePatient(boothNum);
                ...
                vaccinationCenterClass.storeProgramDataToFile(boothClass);
            }else if(menuChoice.equalsIgnoreCase("106") || menuChoice.equalsIgnoreCase("LPD")) {
                boothClass = vaccinationCenterClass.getDataFromFile(boothClass);
